...
This playable post is [public domain (CC0)](http://creativecommons.org/publicdomai
This repository also has some baked in merge conflicts for practice.
This repository is also being used as a part of GitHub training, to practice Git and GitHu
